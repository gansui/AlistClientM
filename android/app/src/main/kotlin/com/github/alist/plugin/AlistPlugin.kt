...
import com.github.alist.service.BackgroundAudioService
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "startBackgroundAudioService" -> {
                val intent = Intent(context, com.github.alist.service.BackgroundAudioService::class.java)
                intent.action = com.github.alist.service.BackgroundAudioService.ACTION_START
            ...
            "stopBackgroundAudioService" -> {
                val intent = Intent(context, com.github.alist.service.BackgroundAudioService::class.java)
                intent.action = com.github.alist.service.BackgroundAudioService.ACTION_STOP
