...
基于 [AlistClient N] (https://github.com/nu1lkali/AlistClientN)的修改，在1.3.3版本基础上修改。
感谢 nu1lkali [AlistClient N](https://github.com/BFWXKJGS/AlistClient) 的增强版 Android 客户端，
感谢原作者 [BFWXKJGS](https://github.com/BFWXKJGS) 的开源贡献。

###本版本做了如下增强
- 1.支持视频播放时关屏，声音不停 
- 2.增加了睡眠定时 
- 3.对MPV播放器增加了记录视频停止时间 
- 4.删除了ExoPlayer
- 5.增加了播放视频时翻转功能
- 6.播放时暂停、快进等按钮颜色变为浅绿色，以避免经常和视频背景颜色混淆

## 下载

**GitHub Releases**
https://github.com/gansui/AlistClientM/releases

以下是AlistClientN的功能介绍
## 新增功能
...
本项目基于 [AlistClientN]([(https://github.com/nu1lkali/AlistClientN)]) 开发，感谢原作者的开源贡献。
